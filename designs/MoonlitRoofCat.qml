// source: wallsflow
// name: Moonlit Roof Cat
// description: Wallsflow live wallpaper
// "Moonlit Rooftop Cat" live wallpaper (wallsflow.com), used as a lock
...
DesignBase {
  ...
  readonly property string assetsUrl: Qt.resolvedUrl("moonlit-rooftop-cat-assets/")
  property color accent: "#f0cf7a"
  property color dim: Qt.rgba(1, 1, 1, 0.5)

  Rectangle { anchors.fill: parent; color: "#0c0e1e" }
